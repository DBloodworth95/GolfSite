									...
									<div class="col-md-8">
										<div class="info">
											<div class="row">
												...
												<div class="col-md-4 basket-quantity">
													<label for="basket-quantity">Quantity:</label>
													<input id="basket-quantity" type="number" value="1"
														class="form-control basket-quantity-input">
												</div>
